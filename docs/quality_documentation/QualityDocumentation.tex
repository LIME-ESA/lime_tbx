...
\usepackage{array}       % Fixes column formatting in tables
\usepackage{colortbl}    % Fixes color-related table errors
\usepackage{longtable}   % Ensures longtable support
\usepackage{tabularx}    % Allows dynamic column width adjustments
...
\usepackage{pgffor}
\usepackage{verbdef}
\usepackage{usermanualRequirements}

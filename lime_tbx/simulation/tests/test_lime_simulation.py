...
class TestLimeSimulation(unittest.TestCase):
    ...
    def test_update_polarization(self):
        ...
        cimel_refs = np.array(
            [
                [
                    0.057496835043516284,
                    0.04920034788916958,
                    0.045211935405303376,
                    0.04244168383481754,
                    0.04274484312255756,
                    0.04615651316413576,
                ],
                [
                    0.042484643389700864,
                    0.03641665901567368,
                    0.033478297362247424,
                    0.03146943519717083,
                    0.03170468952009604,
                    0.03417453239940476,
                ],
        ...
        cimel_unc_refs = np.array(
            [
                [2.08e-17, 2.78e-17, 7.63e-17, 6.25e-17, 3.47e-17, 9.02e-17],
                [4.86e-17, 6.25e-17, 2.78e-17, 1.39e-17, 4.16e-17, 4.16e-17],
            ]
        )
        for cimel, data, unc in zip(cimels, cimel_refs, cimel_unc_refs):

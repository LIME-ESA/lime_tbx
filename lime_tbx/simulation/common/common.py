...
#     ) -> Tuple[Union[List[float], List[List[float]]], SpectralData]:
#         """
...
#
#     @staticmethod
#     def _get_data_eli_cimel(md: MoonData, cimel_data: CimelData, calc_uncertainty: bool=True):
#         elis_cimel = eli.calculate_eli_band(cimel_data,md)
#         u_elis_cimel = None
#         if calc_uncertainty:
#             u_elis_cimel = eli.calculate_eli_band_unc(cimel_data, md)
#         spectral_data = SpectralData(cimel_data.wavelengths, elis_cimel, u_elis_cimel)
#         return spectral_data
#
#     @staticmethod
#     def _get_data_elref_cimel(md: MoonData, cimel_data: CimelData, calc_uncertainty: bool=True):
#         elrefs_cimel = elref.band_moon_disk_reflectance(cimel_data,md)
#         u_elrefs_cimel = None
#         if calc_uncertainty:
#             u_elrefs_cimel = elref.band_moon_disk_reflectance_unc            _band_unc(cimel_data, md)
#         spectral_data = SpectralData(cimel_data.wavelengths, elrefs_cimel, u_elrefs_cimel)
#         return spectral_data
#
#     @staticmethod
#     def get_eli_from_md(

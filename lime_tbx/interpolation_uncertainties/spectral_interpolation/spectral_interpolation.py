...
def interpolate_1d(x_i,y_i,x,method="cubic",unc_methods=None,u_y_i=None,min_scale=0.3,return_uncertainties=False,add_error=False,return_corr=False):
    """
    ...
    if method.lower()=="gpr":
        ...
        if return_uncertainties or return_corr:
            ...
            y_unc,y_corr=std_interpolation_methods(x_i,y_i,x,y,unc_methods)
...
def unc_methods_interpolate_1d(method):
    if method.lower() == "nearest":
        return ["previous", "next", "linear"]
    elif method.lower() == "linear":
        return ["nearest","quadratic"]

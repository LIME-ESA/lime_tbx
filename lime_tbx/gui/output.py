...
class GraphWidget(QtWidgets.QWidget):
    ...
    def _redraw(self):
        ...
        self.canvas.axes.fill_between(self.x_data, np.array(self.y_data_intp)-np.array(self.u_y_data_intp),np.array(self.y_data_intp)+np.array(self.u_y_data_intp),"b",alpha=0.3)

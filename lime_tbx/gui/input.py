...
class CustomInputWidget(QtWidgets.QWidget):
    ...
    def _build_layout(self):
        ...
        self.dist_sun_moon_spinbox.setDecimals(8)
        ...
        self.dist_obs_moon_spinbox.setDecimals(5)
        ...
        self.moon_phase_angle_spinbox.setDecimals(6)

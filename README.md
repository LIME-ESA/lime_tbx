...
The structure of the **lime_tbx** project is visualized in the composite structure diagram:
...
Refer to `quality_documentation/uml/composite_structure.png` for details about the organization and components of the project.
